        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-0 items-end">
          ...
          <div className={`md:col-span-4 pb-10 transition-all duration-700 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
            ...
            <div className="flex flex-wrap items-center gap-x-5 gap-y-2 mb-6">
              <a href="https://docs.tokamak.network" target="_blank" rel="noopener noreferrer" className="text-sm uppercase text-black/60 hover:text-black transition-colors">
                {t.footer.docs}
              </a>
            ...
            <div className="flex items-center gap-4">
              <a href="https://x.com/tokaboratory" target="_blank" rel="noopener noreferrer" aria-label="X (Twitter)" className="text-black/40 hover:text-black transition-colors">
              ...
              <a href="https://discord.gg/tokamaknetwork" target="_blank" rel="noopener noreferrer" aria-label="Discord" className="text-black/40 hover:text-black transition-colors">
