const en = {
  ...
  onboarding: {
    ...
    quest1Intro2: "To start staking, you need a 'wallet' to keep your coins in.",
    quest1Intro3: "Think of it as your own personal bank app for crypto. You can store, send, and receive coins here.",
    quest1Intro4: "Let's create your wallet first! Just sign in with Google or email.",
    ...
    quest2Intro1: "To withdraw TON from exchanges, you need wallet verification — and that only works with MetaMask.",
    quest2Intro2: "We'll copy your private key into MetaMask so you can use the same wallet from both apps.",
    ...
    quest3Intro1: "Time to verify your wallet on the exchange!",
    quest3Intro2: "In your exchange app: Register personal wallet → Select Ethereum (ETH) network → Sign with MetaMask!",
