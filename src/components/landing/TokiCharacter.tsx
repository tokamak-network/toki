  ...
  return (
    <div className={`relative ${className}`}>
      ...
      >
        ...
        {/* Body / Dress */}
        <path
          d="M70 135 Q70 145 60 190 L140 190 Q130 145 130 135"
          fill="url(#dressGrad)"
        />
        {/* Collar */}
        <path
          d="M75 135 L100 150 L125 135"
          stroke="#22d3ee"
          strokeWidth="2"
          fill="none"
        />
        ...
        <g className="animate-pulse-slow">
          ...
          <path
            d="M170 70 L173 65 L176 70 L173 75Z"
            fill="#22d3ee"
            opacity="0.8"
          />
          <path
            d="M45 180 L48 175 L51 180 L48 185Z"
            fill="#ff6b9d"
            opacity="0.6"
          />
          <path
            d="M155 190 L158 185 L161 190 L158 195Z"
            fill="#c084fc"
            opacity="0.6"
          />
        </g>
