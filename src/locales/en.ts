const en = {
  ...
  onboarding: {
    ...
    quest1Intro4: "By the way, a 'wallet' is an app that manages your account. MetaMask is a wallet — your account lives inside it!",
    ...
    quest2Intro2: "We'll copy your private key into MetaMask so you can use the same account from both apps.",
    quest2Intro3: "Don't worry, it's easy in 3 steps!",
