  ...
  return [
    ...
    },
    {
      ...
      intro: [
        ...
        { text: t.quest2Intro5, mood: "explain" },
    ...
    },
    {
      ...
      intro: [
        ...
        { text: t.quest3Intro2, mood: "cheer" },
        { text: t.quest3Intro3, mood: "explain" },
        { text: t.quest3Intro4, mood: "explain" },
        { text: t.quest3Intro5, mood: "explain" },
