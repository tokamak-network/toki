      ...
      >
        ...
        <div className="text-red-400/80 text-sm flex items-start gap-2">
          <svg
            ...
            height="16"
            viewBox="0 0 20 20"
            className="shrink-0 mt-0.5 text-red-500/60"
            fill="currentColor"
          >
            <path
              fillRule="evenodd"
...
export default function WhyToki() {
  ...
  const comparisons = [
    {
      feature: t.whyToki.walletSetup,
      old: t.whyToki.walletTraditional,
      toki: t.whyToki.walletToki,
    },
    {
      feature: t.whyToki.gasFees,
      old: t.whyToki.gasTraditional,
      toki: t.whyToki.gasToki,
    },
    {
      feature: t.whyToki.wrapping,
      old: t.whyToki.wrappingTraditional,
      toki: t.whyToki.wrappingToki,
    },
    {
      feature: t.whyToki.operatorSelection,
      old: t.whyToki.operatorTraditional,
      toki: t.whyToki.operatorToki,
    },
    {
      feature: t.whyToki.stepsToStake,
      old: t.whyToki.stepsTraditional,
      toki: t.whyToki.stepsToki,
    },
  ];
